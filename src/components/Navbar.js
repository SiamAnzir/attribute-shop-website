                ...
                <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
                    <Nav>
                        <div style={{border:"2px solid red",borderRadius:'10px'}}>
                            <NavItem> <Nav.Link href="#products" className="text-black text-decoration-none"> Services/Products  </Nav.Link> </NavItem>
                        </div>
                        <div style={{paddingRight:'20px'}}></div>
                        <div style={{border:"2px solid red",borderRadius:'10px'}}>
                            <NavItem> <Nav.Link href="#contact" className="text-black text-decoration-none"> Contact Us  </Nav.Link> </NavItem>
                        </div>
                    </Nav>
                </Navbar.Collapse>
            </Container>
